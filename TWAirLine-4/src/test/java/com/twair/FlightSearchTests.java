...
public class FlightSearchTests {
    ...
    public void setUp() throws Exception {
        ...
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 30, 1100.0));
        ...
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 5, 1100.0));
        travelClasses.add(new TravelClass(ClassType.BUSINESS, 5, 2200.0));
    ...
    @Test
    public void shouldGiveTheTotalPrice() {
