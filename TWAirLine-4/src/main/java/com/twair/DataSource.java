...
public class DataSource {
    ...
    public FlightSearch fetchFlights() throws Exception {
        ...
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 195, 1000.0));
        travelClasses.add(new TravelClass(ClassType.BUSINESS, 35, 2000.0));
        travelClasses.add(new TravelClass(ClassType.FIRST, 8, 3000.0));
        ...
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 144, 1100.0));
        ...
        travelClasses = new ArrayList<>();
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 152, 1200.0));
        travelClasses.add(new TravelClass(ClassType.BUSINESS, 20, 2200.0));
